...
?>
 ...
 (A CSEA INITIATIVE)
		...
		<!--</div>-->
		<div id="nav-bar" class="sidenav-selected">
			<div class="editiontitle" id="editiontitle"><?php echo $edrow['name']; ?></div>
			<?php
while($row=$result->fetch_assoc())
{
  ...
  ?>
				...
				<button class="dropdown-btn" onclick="loadarticle(<?php  echo $row["id"]; ?>);"><?php  echo $row['title']; ?>
